...
def classify_scene(video_path):
    ...
    # return  result
    print(result)
    #return classification if final_probability > 0.45 else fps_based_classification
    return fps_based_classification
...
# def analyze_fps(video_path):
#     fps = get_fps_opencv(video_path)
#     if 22 <= fps <= 26:
#         return 1.0  # Movie scene
#     elif fps == 0:
#         return 1.0  # Assume missing FPS means it's a movie
#     else:
#         return 0.0  # Real-life scene

# def classify_scene(video_path):
#     fps_prob = analyze_fps(video_path)  # FPS-based probability
...
#     final_probability = (
#         (fps_prob * 0.5) +  # Assign weight to FPS
#         (audio_prob * 0.10) +
#         (scene_change_prob * 0.10) +
#         (edge_prob * 0.10) +
#         (brightness_prob * 0.10) +
#         (motion_prob * 0.10)
#     )
#     classification = "Movie Scene" if final_probability > 0.50 else "Real-Life Scene" 
    
#     result = {
#         "FPS Probability": fps_prob,
#         "Audio-based Probability": audio_prob,
#         "Scene Change Probability": scene_change_prob,
#         "Edge Density Probability": edge_prob,
#         "Brightness Variance Probability": brightness_prob,
